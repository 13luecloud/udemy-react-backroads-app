      ...
      <div class="section-center featured-center">
        <article class="tour-card">
          <div class="tour-img-container">
            <img src={tourOneImg} class="tour-img" alt="" />
        ...
        <article class="tour-card">
          <div class="tour-img-container">
            <img src={tourTwoImg} class="tour-img" alt="" />
        ...
        <article class="tour-card">
          <div class="tour-img-container">
            <img src={tourThreeImg} class="tour-img" alt="" />
        ...
        <article class="tour-card">
          <div class="tour-img-container">
            <img src={tourFourImg} class="tour-img" alt="" />
